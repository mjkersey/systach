...
**
** Created: Mon Jan 27 22:47:13 2014
...
public:
    ...
    void setupUi(QWidget *datasourceSettings)
    {
        ...
        sensorTree = new QTreeWidget(groupBox);
        sensorTree->setObjectName(QString::fromUtf8("sensorTree"));
        sensorTree->setGeometry(QRect(90, 341, 351, 101));
    ...
    void retranslateUi(QWidget *datasourceSettings)
    {
        ...
        QTreeWidgetItem *___qtreewidgetitem = sensorTree->headerItem();
        ___qtreewidgetitem->setText(0, tr2i18n("Sensor", 0));
    } // retranslateUi
